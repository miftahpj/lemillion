  ...
  <div class="min-h-screen bg-[#080604] flex font-body">
    ...
    <main class="ml-56 flex-1 p-8">
      ...
      <div v-else class="text-center py-20 border" style="border-color:rgba(255,255,255,0.04);">
        ...
        <p class="font-mono text-[9px] tracking-widest uppercase" style="color:rgba(245,240,232,0.10);">Tambah data via aiven/02_seed.sql atau query manual di Aiven Console.</p>
      </div>
    </main>
  </div>
</template>
