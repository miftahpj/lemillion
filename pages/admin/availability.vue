<template>
  <div class="min-h-screen bg-[#080604] flex font-body">
    ...
    <main class="ml-56 flex-1 p-8">
      ...
      <p v-if="availability.length === 0" class="text-center py-10 font-serif italic" style="color:rgba(245,240,232,0.2);">Data availability belum ada. Jalankan aiven/02_seed.sql terlebih dahulu.</p>
    </main>
  </div>
</template>
